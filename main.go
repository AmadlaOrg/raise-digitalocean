...
import (
	...
	"github.com/AmadlaOrg/raise-digitalocean/digitalocean"
...
const (
	appName = "raise-digitalocean"
	version = "1.0.0"
)

var rootCmd = &cobra.Command{
	Use:     appName,
	Short:   "Raise plugin for managing DigitalOcean Droplets",
	Version: version,
}
		...
		Run: func(cmd *cobra.Command, args []string) {
			metadata := map[string]any{
				...
				"supports": []string{
					...
					"amadla.org/entity/infrastructure/cloud@^v1.0.0",
				},
				"description": "Manages DigitalOcean Droplets via doctl CLI",
			}
...
var haltCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		mgr := digitalocean.New()
		if err := mgr.Halt(args[0]); err != nil {
			fmt.Fprintf(os.Stderr, "Error: %v\n", err)
			os.Exit(1)
		}
		fmt.Fprintf(os.Stderr, "Droplet %q is powering off\n", args[0])
		return nil
	},
}
...
var destroyCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Fprintf(os.Stderr, "Droplet %q has been destroyed\n", args[0])
		return nil
	},
}
...
var statusCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if len(args) == 1 {
			...
			return digitalocean.OutputJSON(state)
		}
		...
		return digitalocean.OutputJSON(states)
	},
}
...
func parseEntityToConfig(data []byte) (*digitalocean.DropletConfig, error) {
	...
	body := entity.Body
	config := &digitalocean.DropletConfig{
		Region:  body.Region,
		Size:    body.Size,
		Image:   body.Image,
		SSHKeys: body.SSHKeys,
		VpcUUID: body.VpcUUID,
		Tags:    body.Tags,
	}
